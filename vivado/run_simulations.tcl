...
set simdir [file join $root build laplace_sim]
create_project -force laplace_sim $simdir -part $part
add_rtl laplace
add_files -fileset sim_1 [glob [file join $root data pid_*.mem]]
...
foreach test $tests {
    ...
    run all
    close_sim
    set logpath [file join $simdir laplace_sim.sim sim_1 behav xsim simulate.log]
...
gate mark sim
puts "XSIM REGRESSION PASS laplace"
